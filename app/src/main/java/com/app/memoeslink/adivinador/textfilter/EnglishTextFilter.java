...
public class EnglishTextFilter implements TextFilter {
    ...
    public static final String SEXUAL_INTERCOURSE_PROFANITY_REGEX = "(" + "fuck[a-zA-Z]+|fornicate|fornicators?|fornications?|sex|sexual|copulate|copulations?|orgasms?|genitalia|org(y|ies)|blowjobs?|(dick|cock)(lick|suck|eat)(ers?|ing)|fellatio|fellations?|erections?|semen|cums?|ejaculations?|ejaculatory|jizz(es)?|cockfoam|boners?|anilingus" + ")";
    ...
    public static final String MALE_GENITALIA_PROFANITY_REGEX = "(" + "dicks?|c[o0]cks?|penis(es)?|testicles?|testicular|choads?|scrot(ums?|a)|ballsacks?|smegma" + ")";
    public static final String FECAL_MATTER_PROFANITY_REGEX = "(" + "sh[i1!]ts?|shites?|craps?|turds?|fa?eces|fecal" + ")";
    public static final String MASTURBATION_PROFANITY_REGEX = "(" + "masturbate|masturbations?|masturbatory|masterbate|fap|onanisms?" + ")";
    public static final String HOMOSEXUALITY_PROFANITY_REGEX = "(" + "fag(got)?s?|dykes?|sodomites?|lesbos?|trann(y|ies)|siss(y|ies)|cuntboys?|transexuals?|shemales?" + ")";
    ...
    public static final String RACIST_OR_XENOPHOBIC_SLURS_REGEX = "(" + "niggers?|niggas?|wetbacks?|beaners?|nazis?|crackers?" + ")";
