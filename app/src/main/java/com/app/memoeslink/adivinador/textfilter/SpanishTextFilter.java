...
public class SpanishTextFilter implements TextFilter {
    ...
    public static final String MALE_GENITALIA_PROFANITY_REGEX = "(" + "p[e3]n[e3](cito|zote)?s?|verg(a|uita|ota)s?|verg(ón|ones|onas?|ud[oa]s?)|verguer[oa]s?|vergazos?|pij(a|ita|ota)s?|pijud[oa]s?|testículos?|escrotos?|próstatas?|prostátic[oa]s?|pijud[0a]s?|prepucios?|chotas?|glandes?|esmegma" + ")";
