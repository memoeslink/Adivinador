...
public class SpanishTextFilter implements TextFilter {
    public static final String CENSOR_REGEX = "(?<start>^|\\s+|[^\\p{IsLatin}])(?<text>" + "sexo|sexual(es)?|coitos?|(coital(es)?)|fornicador([ea]s)?|fornicación|fornicatori[oa]s?|orgasmos?|orgásmic[oa]s?|genital(es)?|copular|cópular|copulatori[oa]s?|follar|follatori[oa]s?|follador(es|as?)?|foll(ón|ones|onas?)|follaculos?|" +
            ...
            "p[e3]n[e3]s?|vergas?|verg(uita|ota)s?|vergud[oa]s?|verg(ón|ones)|verguer[oa]s?|vergazos?|pijas?|pijud[oa]s?|testículos?|escrotos?|próstatas?|prostátic[oa]s?|erecci(ón|ones)|pijud[0a]s?|dildos?|prepucios?|esmegma|chotas?|bukkake|" +
            ...
            "semen|eyacular|eyaculaci(ón|ones)|eyaculatori[oa]s?|masturbaci(ón|ones)|masturbatori[oa]s?|onanismos?|puñetas?|puñeter[oa]s?|chaqueter[oa]s?|pajer[oa]s?|" +
            ...
            "(lame|chupa|mama|muerde)(culo|pija|huevo|bola|verga|polla|pene|escroto|prepucio|nalga|chota)s?|carevergas?|caraculos?|" +
            ...
            "maric(as?|ón|onas?|ones)|mariquitas?|trolazos?|jotos?|jotol(ón|ones)|jotaz[oa]s?|jototes?|joterías?|amariconad[oa]s?|muerdealmohadas?|mariconaz[oa]s?|jotísim[oa]s?|sodomitas?|" +
            "prostitut[oa]s?|sexoservidor(es|as?)?|rameras?|" +
            "pornografía|pornográfic[oa]s?|p[o0]rn[o0]s?|z[o0]{2}filia|zoofílic[oa]s?|bestialismo|pedofilia|(sado)?masoquismo|(sado)?masoquistas?|sodomías?|" +
            //"|" +
            //"|" +
            ")(?<end>\\s+|[^\\p{IsLatin}]|$)";
